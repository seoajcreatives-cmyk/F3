...
<header>
    ...
    <a href="mailto:f3construction@gmail.com">
        ...
        <div class="social-icon">
            ...
            <a id="btn_social" href="https://www.tiktok.com/@f3construction_ny" target="_blank" aria-label="tiktok"><i class="fa-brands fa-tiktok"></i></a>
            <a id="btn_social" href="https://www.instagram.com/f3constructionny?igsh=dTZ2cTZ4NXp2aHRt" target="_blank" aria-label="instagram"><i class="fa-brands fa-instagram"></i></a>
            <a id="btn_social" href="https://www.google.com/search?hl=en&authuser=0&gl=co&output=search&q=F3+Construction+Corp&ludocid=4353299437963021024&gsas=1&lsig=AB86z5Uhqch1JIsGnD4QLuWF2d_2&ved=1i%3A2%2Ct%3A109124%2Ce%3A1%2Cp%3AZmLZY8WEOZ6BkvQPiICT8Ac%3A1" target="_blank" aria-label="gmb"><i class="fa-solid fa-store"></i></a>
            <a id="btn_social" href="https://yelp.com/biz/f3-construction-central-islip" target="_blank" aria-label="yelp"><i class="fa-brands fa-yelp"></i></a>
        </div>
    </div>
    ...
    <div class="mobile-header" id="mobile-header">
        <div class="mobile-header-container">
            ...
            <div class="mobile_blur" onclick="active_toggle()"></div>
            ...
            <div class="side-bar-box">
                ...
                <div class="button-header-mobile">
                    <a id="btn_social" href="https://www.facebook.com/f3construction/ " target="_blank" aria-label="Facebook"><i class="fa-brands fa-facebook-f"></i></a>
                    <a id="btn_social" href="https://www.tiktok.com/@f3ccorp" target="_blank" aria-label="tiktok"><i class="fa-brands fa-tiktok"></i></a>
                    <a id="btn_social" href="https://www.instagram.com/f3ccorp/ " target="_blank" aria-label="instagram"><i class="fa-brands fa-instagram"></i></a>
                    <a id="btn_social" href="https://www.google.com/search?hl=en&authuser=0&gl=co&output=search&q=F3+Construction+Corp&ludocid=4353299437963021024&gsas=1&lsig=AB86z5Uhqch1JIsGnD4QLuWF2d_2&ved=1i%3A2%2Ct%3A109124%2Ce%3A1%2Cp%3AZmLZY8WEOZ6BkvQPiICT8Ac%3A1" target="_blank" aria-label="gmb"><i class="fa-solid fa-store"></i></a>
                    <a id="btn_social" href="https://yelp.com/biz/f3-construction-central-islip" target="_blank" aria-label="yelp"><i class="fa-brands fa-yelp"></i></a>
                </div>
            </div>
...
<script>
    function active_toggle() {
        ...
        document.querySelector("#mobile-header").classList.toggle("toggle_active");
        document.querySelector(".mobile_toggle").classList.toggle("close_toggle");
